...
ID_PERFIL INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_USUARIO INTEGER NOT NULL UNIQUE,
INSCRICAO VARCHAR(14) NOT NULL,
DT_NASCTO DATE NOT NULL,
FOTO VARCHAR(50),
AVISO_FATURA_VENCIDA BIT DEFAULT 0,
AVISO_FATURA_AVENCER BIT DEFAULT 0,
...
ID_EMPRESA INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
INSCRICAO VARCHAR(14) NOT NULL,
DESCRICAO VARCHAR(100),
...
ID_UNIDADE INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
DESCRICAO VARCHAR(100),
...
ID_PRODUTO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_BANCO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_CONTA INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_BANDEIRA INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_CARTAO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_EVENTO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
...
ID_LANCTO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_EMPRESA INTEGER NOT NULL,
ID_USUARIO INTEGER NOT NULL,
...
DESCRICAO VARCHAR(100),
DT_REGISTRO TIMESTAMP DEFAULT TIMESTAMP,
...
ID_FATURA INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_EMPRESA INTEGER NOT NULL,
...
ID_PARCELA INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_LANCTO INTEGER NOT NULL,
...
ID_PAGAMENTO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
...
ID_DOCUMENTO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_LANCTO INTEGER NOT NULL,
NOME VARCHAR(50) NOT NULL,
DOCUMENTO VARCHAR(100),
UPLOAD BIT DEFAULT 0 NOT NULL,
...
ID_EXTRATO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
ID_CONTA INTEGER NOT NULL,
...
ID_PERIODIC INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
...
ID_PERMISSAO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
DESCRICAO VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS FINANCEIRO.ROLES(
ID_ROLE INTEGER NOT NULL DEFAULT AUTOINCREMENT,
NOME VARCHAR(50) NOT NULL,
DESCRICAO VARCHAR(100),
...
CONSTRAINT FK_PERMISSOES_ROLES_ROLES FOREIGN KEY(ID_ROLE) REFERENCES FINANCEIRO.ROLES(ID_ROLE)
);
...
CONSTRAINT FK_USUARIOS_ROLES_ROLES FOREIGN KEY(ID_ROLE) REFERENCES FINANCEIRO.ROLES(ID_ROLE)
);

CREATE TABLE IF NOT EXISTS PERIODIC_ACTIONS_CONFIGURACOES_INTERVALO_EXECUCAO(
ID_CONFIGURACAO INTEGER NOT NULL DEFAULT AUTOINCREMENT,
